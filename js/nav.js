                  ...
                  <div class="navbar-nav mx-auto">
                      ...
                      <div class="nav-item dropdown">
                          ...
                          <div class="dropdown-menu bg-light">
                              <a href="leaveApplication.html" class="dropdown-item">	Leave Application </a>
                              <a href="employees-information.html" class="dropdown-item">View employees information</a>
                              <a href="company-policies.html" class="dropdown-item">Company Policies</a>
                              <a href="taskManagement.html" class="dropdown-item">Task Managment</a>
